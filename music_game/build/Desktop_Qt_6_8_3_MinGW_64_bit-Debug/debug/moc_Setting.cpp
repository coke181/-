...
static constexpr auto qt_meta_stringdata_ZN7SettingE = QtMocHelpers::stringData(
    "Setting",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7SettingE[] = {
...
Q_CONSTINIT const QMetaObject Setting::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7SettingE.offsetsAndSizes,
    qt_meta_data_ZN7SettingE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7SettingE_t,
        // Q_OBJECT / Q_GADGET
...
void *Setting::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7SettingE.stringdata0))
